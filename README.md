...
- Build an image locally - `docker buildx build -t kyero/ruby:TAG_NAME --platform linux/amd64,linux/arm66 .`
- Build an image and push to DockerHub - `docker buildx build -t kyero/ruby:TAG_NAME --platform linux/amd64,linux/arm66 . --push`
